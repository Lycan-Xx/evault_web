...
const TermsAndConditions = () => {
  ...
  <h1 className="text-4xl font-bold text-blue-900 mt-[5rem]">Terms and Conditions for eVault</h1>
  
  <h2 className="text-2xl font-bold text-orange-500 mt-8 mb-6">1. Introduction</h2>
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">2. Registration and Account Setup</h2>
  <ul className="text-gray-700 leading-loose mb-4 list-disc list-inside">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">3. Use of Services</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">4. Third-Party Services</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">5. Privacy and Data Protection</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">6. Payment Processing</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">7. Security and Fraud Prevention</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">8. Limitation of Liability</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">9. Changes to Terms</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">10. Governing Law and Dispute Resolution</h2>
  <p className="text-gray-700 leading-loose mb-4">
  ...
  <h2 className="text-2xl font-bold text-orange-500 mt-6 mb-2">11. Contact Information</h2>
  <p className="text-gray-700 leading-loose mb-4">
